...
$rocket_cookie_hash = '7e346c0d2b269fc567ccecc40c844035';
$rocket_logged_in_cookie = 'wordpress_logged_in_7e346c0d2b269fc567ccecc40c844035';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_secret_cache_key = '6194653f807d0083893536';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_webp = 0;
$rocket_cache_ssl = 1;
$rocket_cache_reject_uri = '/WEB/WP-BANHANG(/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/checkout/(.*)|/cart/|/my-account/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$))';
